...
hi Directory      term=bold cterm=bold ctermfg=7 ctermbg=0 gui=none guifg=LightGray guibg=black
...
hi LineNr         term=underline cterm=bold ctermfg=0 guifg=DarkGray
...
hi NonText        term=bold cterm=bold ctermfg=0 gui=none guifg=DarkGray
